...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-400 to-purple-500 text-white p-4">
      <h1 className="text-4xl font-bold mb-6">Welcome to AI Analyst Chat</h1>
      <p className="text-xl mb-8 text-center">Experience the power of AI-driven financial analyst. To get started, please login with your email.</p>
